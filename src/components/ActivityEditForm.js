...
export default class ActivityEditForm extends Component {
    ...
    componentWillMount() {
        document.title = 'Arena | Editar actividad';
    ...
    render() {
        ...
        const {
            sport, sports, activityLoading, sportsLoading, startDate, startTime, duration, title,
            description, location, seats, putActivity, isRedirectable,
        } = this.props;
